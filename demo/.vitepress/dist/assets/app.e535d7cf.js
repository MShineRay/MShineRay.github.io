...
const _sfc_main$x = {};
const _withScopeId$7 = (n) => (pushScopeId("data-v-826d4824"), n = n(), popScopeId(), n);
const _hoisted_1$n = {
  class: "VPNavBarTitle",
  href: "/"
};
...
function _sfc_render(_ctx, _cache) {
  return openBlock(), createElementBlock("a", _hoisted_1$n, _hoisted_4$8);
}
var VPNavBarTitle = /* @__PURE__ */ _export_sfc(_sfc_main$x, [["render", _sfc_render], ["__scopeId", "data-v-826d4824"]]);
...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  setup(__props) {
    const { theme } = useData();
    const VPAlgoliaSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPAlgoliaSearchBox.4be629aa.js"), true ? [] : void 0));
    const loaded = ref(false);
    const metaKey = ref();
    onMounted(() => {
