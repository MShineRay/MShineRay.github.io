...
const _sfc_main$1 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.ssrRenderAttrs(vue.mergeProps({ id: "api-index" }, _attrs))} data-v-63ca48f6><div class="header" data-v-63ca48f6><h1 data-v-63ca48f6>Image List</h1><div class="api-filter" data-v-63ca48f6><label for="api-filter" data-v-63ca48f6>Filter</label><input type="search" placeholder="Enter keyword" id="api-filter"${serverRenderer.ssrRenderAttr("value", query.value)} data-v-63ca48f6></div></div><!--[-->`);
      serverRenderer.ssrRenderList(vue.unref(filtered), (section) => {
        _push(`<div class="api-section" data-v-63ca48f6><h2${serverRenderer.ssrRenderAttr("id", slugify(section.text))} data-v-63ca48f6>${serverRenderer.ssrInterpolate(section.text)}</h2><div class="api-groups" data-v-63ca48f6><!--[-->`);
        serverRenderer.ssrRenderList(section.items, (item) => {
          _push(`<div class="api-group" data-v-63ca48f6><a${serverRenderer.ssrRenderAttr("href", item.link + ".html")} data-v-63ca48f6><h3 data-v-63ca48f6>${serverRenderer.ssrInterpolate(item.text)}</h3></a></div>`);
        });
        _push(`<!--]--></div></div>`);
      });
      _push(`<!--]-->`);
      if (!vue.unref(filtered).length) {
        _push(`<div class="no-match" data-v-63ca48f6> No image matching &quot;${serverRenderer.ssrInterpolate(query.value)}&quot; found. </div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("read-notes/ReadNotesIndex.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
var ReadNotesIndex = /* @__PURE__ */ pluginVue_exportHelper._export_sfc(_sfc_main$1, [["__scopeId", "data-v-63ca48f6"]]);
const __pageData = '{"title":"Read Notes","description":"","frontmatter":{"title":"Read Notes","page":true,"footer":false},"relativePath":"read-notes/index.md","lastUpdated":1648606789779}';
const __default__ = {};
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(serverRenderer.ssrRenderComponent(ReadNotesIndex, null, null, _parent));
      _push(`</div>`);
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("read-notes/index.md");
