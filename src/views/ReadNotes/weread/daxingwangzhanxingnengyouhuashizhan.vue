<template>
  <div class='container'>
    ...
    <img src='./img/daxingwangzhanxingnengyouhuashizhan/t6_25462652.jpg' alt='written' class='written'>
    <div class='wr_macOS wr_Desktop wr_page_reader wr_whiteTheme'>
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>下面几个要素来衡量网站性能方面的用户体验，并尝试通过不同监控系统进行系统监控和指标量化：● 白屏。● 首屏。● 页面整体加载。● 页面可交互。● 功能交互响应。</div>
            </div>
        </div>
      </div>
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>即用户打开浏览器输入网站的URL后，从屏幕空白到第一个画面出来的时间，这个时间的长短将直接决定网站页面给用户的第一印象。</div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>将白屏时间命名为StartRender，而在最新的Chrome、IE浏览器提供的Performance Timing API中也提供了类似的称为FirstPaint的指标。
            </div></div>
        </div>
      </div>
      <div class='sectionListItem'>
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>DNS Lookup即浏览器从DNS服务器中进行域名查询。</div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        <div class='sectionListItem_divider leftIndent'></div>
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>客户端下载、解析、渲染显示页面服务器返回HTTP
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>关于浏览器下载、解析、渲染显示页面的优化策略，根据渲染步骤，大概可以从以下几个方面着手：● 优化HTML代码和结构，缩短HTML下载时间，加快HTML解析速度。●
              优化CSS文件和结构，缩短CSS文件下载时间和解析时间。● 合理放置JS代码，避免前面第三种情况的出现，这也是最重要的。
            </div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>最关键的是，要能够找到衡量各自页面首屏内容展示速度的办法，通过监控发现潜在的问题，然后做出调整</div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>页面加载完成又称为PageLoad，顾名思义，即页面相关资源（CSS样式文件、JS脚本文件、图片等）全部加载完成的时间。</div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        <div class='sectionListItem_divider leftIndent'></div>
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>如果用户等待加载完成需要的时间超过8s，用户会放弃对页面的进一步浏览，离开网站，从而导致用户流失。</div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        <div class='sectionListItem_divider leftIndent'></div>
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>通常4s左右的平均加载时间，是用户可能会等待页面加载的最长时间。</div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        <div class='sectionListItem_divider leftIndent'></div>
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>[1]DOM树即我们熟知的Document Object
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>《高性能网站建设指南》</div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        <div class='sectionListItem_divider leftIndent'></div>
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>● 尽量减少HTTP请求。● 使用CDN。● 静态资源使用Cache。● 启用Gzip压缩。● JavaScript脚本尽量放在页面底部。● CSS样式表放在顶部。●
              避免CSS表达式。● 减少内联JavaScript和CSS的使用，尽可能使用外部的JavaScript和CSS文件。● 减少DNS查询。● 精简JavaScript。● 避免重定向。● 删除重复的脚本。
            </div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>Google开源的优化工具PageSpeed</div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        <div class='sectionListItem_divider leftIndent'></div>
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>使用WebPagetest进行性能分析</div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        <div class='sectionListItem_divider leftIndent'></div>
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>和YSlow、PageSpeed一样，WebPagetest同样也使用和它们相似的一组最佳性能实践来分析网页。WebPagetest通过浏览器访问，基于输入的Website
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>如果希望网站能够持续为用户提供最佳的性能体验，就需要建立网站自身的性能监控系统。</div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        <div class='sectionListItem_divider leftIndent'></div>
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>一个基础的真实用户性能监控系统的设计，具有日常页面性能监控、预警等功能，并且能够在网站性能发生问题时提供足够的基础性能分析数据。</div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>建立一个基础的真实用户前端性能监控系统，大致包含以下5个系统模块的设计开发工作：● 真实用户前端性能数据采集。● 采集数据存储。● 监控系统指标定义及加工计算。●
              数据分析、性能报表产出。● 性能基线定义。
            </div></div>
        </div>
      </div>
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>下面的维度可以作为常规性能监控系统的常规设计，尤其是当你的网站用户遍布全球时：
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>QPS（吞吐量）</div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        <div class='sectionListItem_divider leftIndent'></div>
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>RT=Thread CPU Time+Thread Wait Time
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>服务器端 RT 的含义是指从服务器接收请求到该请求响应的全部数据被发往客户端的时间间隔。客户端 RT
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>单线程QPS=1000ms /RT</div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        <div class='sectionListItem_divider leftIndent'></div>
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>最佳线程数=（RT/CPU Time）×CPU核数×CPU利用率</div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        <div class='sectionListItem_divider leftIndent'></div>
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>一个好的程序员既要能写出容易被机器理解的代码（执行效率高），又要能写出让其他程序员容易理解的代码（维护成本低）</div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        <div class='sectionListItem_divider leftIndent'></div>
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>解决消耗CPU资源大户Gzip</div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        <div class='sectionListItem_divider leftIndent'></div>
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>TCP 优化在传统的性能优化领域中很容易在应用层面被忽略，通常在 CDN
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>TCP传输是分段的，一个HTTP响应报文会被操作系统切成多个MSS大小（一般为1460
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>● 尽量将操作系统进行版本升级。高版本的Linux操作系统对TCP内核进行了多项优化，包括拥塞窗口变大、Early Transmit等算法优化。●
              ...
              尽量将机房部署在离核心用户近的地方，通过减少网络距离来减少网络耗时。● 尽量选择大的运营商。小的运营商往往在BGP选路时会绕路，造成网络耗时增加。
            </div></div>
        </div>
      </div>
      <div class='sectionListItem'>
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>CDN对于一个大型网站而言，主要提供了6种能力。
              1.静态加速能力
              通过本地化缓存加速能力给用户提供一个尽力而为的就近访问的高性能访问架构，将用户访问的内容缓存在边缘节点上，消除由用户地域差异而导致的用户体验不一致，提供不同地区用户的相对一致的高性能访问体验。
              2.卸载源站能力
              CDN将资源缓存在它的服务器上，访问是在用户和CDN之间进行的，原来用户的直接请求都发送到网站服务器上，移交到 CDN
              ...
              CDN 命中率突然变低，造成源站出现各种不稳定的问题；也可以看到，CDN的命中率对于减小源站的压力十分关键。总而言之，CDN的存在大大减小了源站的压力，提高了网站的稳定性。
              3.防攻击能力
              一般比较成熟的 CDN 提供商至少有数百个 CDN 节点，甚至数千个，而把资源放在
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>5.用户访问序列优化能力
              ...
              2）页面间资源预取
              页面间资源预取指的是在用户访问当前网页时，将要访问页面的资源提前预取到 CDN 边缘节点上，等浏览器下载序列相到对的应资源时，避免回源或者从 CDN 二级缓存节点上获取资源，以减少网络延迟。
              6.定制化模块开发能力
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>CDN实现过程非常复杂，应用CDN技术来做设计方案，不需要把CDN的所有细节都搞清楚，但是需要知道 CDN哪些能做、哪些不能做，用了 CDN 后会带来什么问题等。</div>
            </div>
        </div>
      </div>
      <div class='sectionListItem'>
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>所谓的CSI其实就是通过浏览器端发起Ajax请求，从源站获取实时性和一致性要求高的数据，例如价格信息，网页的其他部分全部可以缓存到 CDN
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>当页面要依赖SEO引流时，必须使用ESI技术，因为搜索引擎的爬虫无法获取异步Ajax的内容。</div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        <div class='sectionListItem_divider leftIndent'></div>
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>ESI 更适合于对重要性内容需要实时化和强一致性的内容静态化的解决方案，CSI 的实时处理部分通常适合对网页重要内容不做更改的情况，如业务打点请求。使用 ESI
              还是CSI需要考虑对用户体验的影响、实时部分的重要性，以及容错处理能力。但是ESI的处理过程相对复杂，改造成本相对较高，源站需要自己实现HTML的拼接逻辑，并做各种容错处理。综上所述，两者比较如下：●
              ESI实现成本较高，容错能力强，页面加载性能较差。● CSI实现成本较低，容错能力弱，页面加载性能较好。
            </div></div>
        </div>
      </div>
      <div class='sectionListItem'>
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>用户序列优化是CDN根据用户请求的HTML内容和浏览器下载的序列进行提前解析，将浏览器需要的资源提前预取到CDN节点上，等到浏览器下载该资源时，该资源已经提前在CDN节点上了
            </div></div>
        </div>
      </div>
      <div class='sectionListItem'>
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>CDN的性能降低通常和大量回源相关，因为CDN节点本身相对比较稳定，特别是网站使用国外顶级的CDN提供商，在性能和可用性方面有保障。</div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        <div class='sectionListItem_divider leftIndent'></div>
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>为什么根据IP库判断不能精准地区分用户？这是因为大部分DNS输入的IP地址是Local
              DNS的IP地址，而不是用户真实的IP地址。在这种情况下，用户的IP地址所在的地区并不和Local DNS IP地址所在的地区相同。
            </div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>大型网站一般都有4层、7层防攻击的能力，为了防止CDN被源站防攻击系统拦截，通常的做法是，将CDN节点的服务器IP列表加入防攻击系统的白名单过滤列表，以防止正常浏览被“误杀”。
            </div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>秒杀商品宝贝页面中商品的基本价格和折扣需要准实时，库存要保持强一致性。强一致性方案采用 CSI
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>● 同域名非加速页面处理的解决方案在非加速页面的response
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>RT（Response Time）表示响应时间，它是从接收请求开始到服务器处理完成的时间差值。</div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        <div class='sectionListItem_divider leftIndent'></div>
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>5.URL监控URL是Web应用通常需要监控的，包含以下关键指标。● 调用量：调用次数及趋势监控，可以进行同比、环比。● 耗时：访问此URL的服务器端耗时。●
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>一个高性能网站一般都会用到缓存架构，缓存意味着高性能，通过空间换时间。</div></div>
        </div>
      </div>
      <div class='sectionListItem'>
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>基于浏览器Cookie的无状态架构Session是有状态的，Session复制的架构会造成扩展能力急剧下降，Cookie的共享方式是，通过浏览器记录，将共享的具体信息存储在
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>在部署时通常要遵守以下基本原则。● 尽量将重要的业务单独进行物理部署重要的业务单独部署可以避免相互影响，因为一处问题会影响全局。●
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>●
              ...
              Server Include）是片段页面缓存的常见解决方案，也是最早出现的CDN缓存HTML 的解决方案，它已经成为一个通用的标准，Varnish 及 Squid
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>从用户体验角度考虑，交易是非常关键的环节，用户访问性能越好，成交转化的可能性越高。</div></div>
        </div>
      </div>
      <div class='sectionListItem'>
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>1.业务垂直化，高内聚低耦合，依赖弱耦合
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>2.服务水平伸缩，和Web应用解除耦合
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>3.可维护性提升</div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        <div class='sectionListItem_divider leftIndent'></div>
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>从高效功能开发角度来说，基于服务的架构最大的好处是将功能之间的强耦合变成松耦合，可维护性更强。</div></div>
        </div>
      </div>
      <div class='sectionListItem'>
      ...
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>大促是大型网站非常重要的营销形式，营销的作用是通过薄利多销的方式来吸引更多用户的关注，拉新是大促最重要的目的之一，运营的三个重要工作是拉新、促活和转化。</div>
          </div>
        </div>
      </div>
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>通常资金安全问题容易发生在并发控制、幂等控制出现问题的时候，其后果是客户少付或多付。</div></div>
        </div>
      </div>
      <div class='sectionListItem'>
        ...
        <div class='sectionListItem_content noteItem_content clickable'><span class='icon'></span>
          <div>
            <div class='text'>智能DNS只做了一件事情，那就是把域名解析成IP地址，其分配方式是轮询，轮询是指每发起一次DNS查询请求，就交叉分配一次IP地址，理论上这个分配肯定是均衡的。</div>
            </div>
        </div>
      </div>
    </div>
