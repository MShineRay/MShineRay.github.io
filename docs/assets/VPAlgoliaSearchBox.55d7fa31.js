import { u as useData, a as useRoute, b as useRouter } from "./app.fdb5113d.js";
import { f as defineComponent, E as onMounted, o as openBlock, b as createElementBlock } from "./plugin-vue_export-helper.e5a60c03.js";
import "./framework.58df9776.js";
...
var l, s, f, p, m, v = {}, d = [], h = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
function y(e2, t2) {
  for (var n2 in t2)
    e2[n2] = t2[n2];
  return e2;
...
function I(e2, t2, n2, r2, o2, i2, c2, a2, u2, l2) {
  ...
  for (n2.__k = [], s2 = 0; s2 < t2.length; s2++)
    if (null != (m2 = n2.__k[s2] = null == (m2 = t2[s2]) || "boolean" == typeof m2 ? null : "string" == typeof m2 || "number" == typeof m2 ? g(null, m2, null, null, m2) : Array.isArray(m2) ? g(S, { children: m2 }, null, null, null) : m2.__b > 0 ? g(m2.type, m2.props, m2.key, null, m2.__v) : m2)) {
  ...
  for (n2.__e = y2, s2 = O2; s2--; )
    null != b2[s2] && ("function" == typeof n2.type && null != b2[s2].__e && b2[s2].__e == n2.__d && (n2.__d = w(r2, s2 + 1)), H(b2[s2], b2[s2]));
  if (_2)
...
function D(e2, t2, n2) {
  ...
  for (r2 = 0; r2 < e2.__k.length; r2++)
    (o2 = e2.__k[r2]) && (o2.__ = e2, t2 = "function" == typeof o2.type ? D(o2, t2, n2) : C(n2, o2, o2, e2.__k, o2.__e, t2));
  return t2;
}
function k(e2, t2) {
...
function x(e2, t2, n2, r2, o2) {
  ...
  e:
    if ("style" === t2)
      ...
      i2 = t2 !== (t2 = t2.replace(/Capture$/, "")), t2 = t2.toLowerCase() in e2 ? t2.toLowerCase().slice(2) : t2.slice(2), e2.l || (e2.l = {}), e2.l[t2 + i2] = n2, n2 ? r2 || e2.addEventListener(t2, i2 ? T : N, i2) : e2.removeEventListener(t2, i2 ? T : N, i2);
  ...
  try {
    e:
      if ("function" == typeof E2) {
        ...
        null == i2 && t2.__v === n2.__v ? (t2.__k = n2.__k, t2.__e = n2.__e) : t2.__e = L(n2.__e, t2, n2, r2, o2, i2, c2, u2);
    (s2 = l.diffed) && s2(t2);
  } catch (e3) {
...
function L(e2, t2, n2, r2, o2, i2, c2, a2) {
  ...
  if (null === h2)
    ...
    if (function(e3, t3, n3, r3, o3) {
      ...
      t2.__k = [];
    else if (y2 = t2.props.children, I(e2, Array.isArray(y2) ? y2 : [y2], t2, n2, r2, o2 && "foreignObject" !== h2, i2, c2, e2.firstChild, a2), null != i2)
      for (y2 = i2.length; y2--; )
        null != i2[y2] && _(i2[y2]);
...
var K, W, z, J = 0, $ = [], Z = l.__b, Q = l.__r, G = l.diffed, Y = l.__c, X = l.unmount;
function ee(e2, t2) {
...
var he = "undefined" != typeof Symbol && Symbol.for && Symbol.for("react.forward_ref") || 3911, ye = function(e2, t2) {
  return null == e2 ? null : k(k(e2).map(t2));
}, _e = { map: ye, forEach: ye, count: function(e2) {
...
var Ie = "undefined" != typeof Symbol && Symbol.for && Symbol.for("react.element") || 60103, De = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|fill|flood|font|glyph(?!R)|horiz|marker(?!H|W|U)|overline|paint|stop|strikethrough|stroke|text(?!L)|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/, ke = function(e2) {
...
var Re, qe = { configurable: true, get: function() {
  return this.class;
} }, Le = l.vnode;
l.vnode = function(e2) {
...
}, __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: He }, Be = ["facetName", "facetQuery"];
function Ve(e2, t2) {
  var n2 = Object.keys(e2);
  if (Object.getOwnPropertySymbols) {
    var r2 = Object.getOwnPropertySymbols(e2);
...
var Xe = ["translations"], et = Fe.forwardRef(function(e2, t2) {
...
var ut = function() {
}, lt = [{ segment: "autocomplete-core", version: "1.9.3" }];
function st(e2) {
...
var At = "https://cdn.jsdelivr.net/npm/search-insights@".concat("2.6.0", "/dist/search-insights.min.js"), xt = nt(function(e2) {
  ...
  var a2 = function(e3) {
      ...
      return function(e5) {
        ...
        if (null != n4) {
          ...
          try {
            ...
            try {
              if (!u3 && null != n4.return && (c3 = n4.return(), Object(c3) !== c3))
                return;
            } finally {
              if (l3)
                throw o4;
    ...
    function i3(t4, n4, r4) {
      if (o3 && void 0 !== r4) {
        ...
        e3.apply(void 0, [t4].concat(dt(n4)));
    }
...
var gn, Sn, On, wn = null, En = (gn = -1, Sn = -1, On = void 0, function(e2) {
  var t2 = ++gn;
...
var xn = ["props", "refresh", "store"], Nn = ["inputElement", "formElement", "panelElement"], Tn = ["inputElement"], Rn = ["inputElement", "maxLength"], qn = ["sourceIndex"], Ln = ["sourceIndex"], Mn = ["item", "source", "sourceIndex"];
function Hn(e2, t2) {
  var n2 = Object.keys(e2);
  if (Object.getOwnPropertySymbols) {
    var r2 = Object.getOwnPropertySymbols(e2);
        ...
        !function(e6) {
          var t4 = e6.event, n4 = e6.props, r4 = e6.refresh, o4 = e6.store, i5 = function(e7, t5) {
            ...
            var n5, r5, o5 = function(e8, t6) {
              ...
              for (r6 = 0; r6 < i7.length; r6++)
                n6 = i7[r6], t6.indexOf(n6) >= 0 || (o6[n6] = e8[n6]);
              return o6;
            }(e7, t5);
            if (Object.getOwnPropertySymbols) {
              var i6 = Object.getOwnPropertySymbols(e7);
              for (r5 = 0; r5 < i6.length; r5++)
                n5 = i6[r5], t5.indexOf(n5) >= 0 || Object.prototype.propertyIsEnumerable.call(e7, n5) && (o5[n5] = e7[n5]);
            }
            return o5;
          }(e6, In);
          if ("ArrowUp" === t4.key || "ArrowDown" === t4.key) {
            ...
            if (t4.metaKey || t4.ctrlKey)
              void 0 !== f3 && (p3.onSelect(kn({ event: t4, item: l3, itemInputValue: s3, itemUrl: f3, refresh: r4, source: p3, state: o4.getState() }, i5)), n4.navigator.navigateNewTab({ itemUrl: f3, item: l3, state: o4.getState() }));
            else if (t4.shiftKey)
              void 0 !== f3 && (p3.onSelect(kn({ event: t4, item: l3, itemInputValue: s3, itemUrl: f3, refresh: r4, source: p3, state: o4.getState() }, i5)), n4.navigator.navigateNewWindow({ itemUrl: f3, item: l3, state: o4.getState() }));
            else if (t4.altKey)
              ;
            else {
              if (void 0 !== f3)
                return p3.onSelect(kn({ event: t4, item: l3, itemInputValue: s3, itemUrl: f3, refresh: r4, source: p3, state: o4.getState() }, i5)), void n4.navigator.navigate({ itemUrl: f3, item: l3, state: o4.getState() });
...
var xr = /(<mark>|<\/mark>)/g, Nr = RegExp(xr.source);
function Tr(e2) {
  var t2, n2, r2 = e2;
...
var Mr = ["translations"], Hr = Fe.memo(function(e2) {
  var t2 = e2.translations, n2 = void 0 === t2 ? {} : t2, r2 = Je(e2, Mr);
  if ("error" === r2.state.status)
    return Fe.createElement(gr, { translations: null == n2 ? void 0 : n2.errorScreen });
...
function Kr(e2) {
  ...
  return { get: function(t3, n3) {
      ...
      !function() {
        ...
        if (c2(r4), t4) {
          var a2 = Object.fromEntries(Object.entries(r4).filter(function(e3) {
            var n6 = i(e3, 2)[1], r5 = new Date().getTime();
    ...
    return Promise.resolve().then(function() {
      var i2 = o2();
      return i2[JSON.stringify(e3)] = { timestamp: new Date().getTime(), value: t3 }, r2().setItem(n2, JSON.stringify(i2)), t3;
    });
  }, delete: function(e3) {
    return Promise.resolve().then(function() {
      var t3 = o2();
    ...
    return Promise.all(n2.map(function(n3) {
      var o2 = n3.params, i2 = o2.facetName, c2 = o2.facetQuery, a2 = function(e3, t2) {
        ...
        var n4, r3, o3 = function(e4, t3) {
          ...
          for (r4 = 0; r4 < i4.length; r4++)
            n5 = i4[r4], t3.indexOf(n5) >= 0 || (o4[n5] = e4[n5]);
          return o4;
        }(e3, t2);
        if (Object.getOwnPropertySymbols) {
          var i3 = Object.getOwnPropertySymbols(e3);
          for (r3 = 0; r3 < i3.length; r3++)
            n4 = i3[r3], t2.indexOf(n4) >= 0 || Object.prototype.propertyIsEnumerable.call(e3, n4) && (o3[n4] = e3[n4]);
        }
        return o3;
      }(o2, Be);
...
function vo(e2, n2, r2) {
  ...
  return function(e3) {
    var n3 = e3.appId, r3 = function(e4, t2, n4) {
      ...
      var t2 = e4.hostsCache, n4 = e4.logger, r4 = e4.requester, o4 = e4.requestsCache, c3 = e4.responsesCache, a2 = e4.timeouts, u2 = e4.userAgent, l2 = e4.hosts, s2 = e4.queryParameters, f2 = { hostsCache: t2, logger: n4, requester: r4, requestsCache: o4, responsesCache: c3, timeouts: a2, userAgent: u2, headers: e4.headers, queryParameters: s2, hosts: l2.map(function(e5) {
        ...
        if (true !== (void 0 !== n5.cacheable ? n5.cacheable : e5.cacheable))
          return r5();
