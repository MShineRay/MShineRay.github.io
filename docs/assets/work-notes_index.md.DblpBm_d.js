...
const data = JSON.parse('[{"text":"读书","type":"/read-notes/weread/","items":[{"text":"js知识点","link":"/work-notes/front-end/js/knowledge-point/"},{"text":"css知识点","link":"/work-notes/front-end/css/knowledge-point/"},{"text":"微信卡片分享","link":"/work-notes/front-end/wxshare"}]}]');
