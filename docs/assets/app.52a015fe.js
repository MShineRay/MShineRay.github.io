...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  setup(__props) {
    const { theme } = useData();
    const VPAlgoliaSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPAlgoliaSearchBox.3ed0a45a.js"), true ? [] : void 0));
    const loaded = ref(false);
    const metaKey = ref();
    onMounted(() => {
      if (metaKey.value) {
