...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  setup(__props) {
    const { theme } = useData();
    const VPAlgoliaSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPAlgoliaSearchBox.2cb81fa1.js"), true ? [] : void 0));
    const loaded = ref(false);
    const metaKey = ref();
    onMounted(() => {
      if (metaKey.value) {
...
export { Fragment as F, _export_sfc as _, createBaseVNode as a, renderList as b, createElementBlock as c, createApp, defineComponent as d, popScopeId as e, createCommentVNode as f, createVNode as g, computed as h, createStaticVNode as i, useData as j, useRoute as k, useRouter as l, onMounted as m, openBlock as o, pushScopeId as p, ref as r, toDisplayString as t, unref as u, vModelText as v, withDirectives as w };
